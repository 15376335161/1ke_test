...
-(void)initPickerView{
    ...
    self.pickerCollectionView.backgroundColor = BackGroundColor;
...
{
    return CGSizeMake(([UIScreen mainScreen].bounds.size.width - 64) /column ,([UIScreen mainScreen].bounds.size.width- 64) /column);
}
...
- (void)changeCollectionViewHeight{
    ...
    if (_collectionFrameY) {
        _pickerCollectionView.frame = CGRectMake(0, _collectionFrameY, [UIScreen mainScreen].bounds.size.width, (((float)[UIScreen mainScreen].bounds.size.width-64.0) /column + marginY)* ((int)(_arrSelected.count)/column +1)+ marginY);
    }
    else{
        _pickerCollectionView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, (((float)[UIScreen mainScreen].bounds.size.width-64.0) /column + marginY)* ((int)(_arrSelected.count)/column +1) + marginY);
    }
...
- (void)updatePickerViewFrameY:(CGFloat)Y{
    ...
    _collectionFrameY = Y;
    _pickerCollectionView.frame = CGRectMake(0, Y, [UIScreen mainScreen].bounds.size.width, (((float)[UIScreen mainScreen].bounds.size.width - 64.0) /column + marginY)* ((int)(_arrSelected.count)/column +1) + marginY);
}
