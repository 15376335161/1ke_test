...
//        if ([[cookie domain]isEqualToString:@"PHPSESSID"]) {
//            cookie_domain = @".xxt.cn";
//        }else{
//            cookie_domain = @".nmgxxt.cn";
//        }
    }
    NSLog(@"%@",cookie_value);
...
//    [[HttpManger sharedInstance]callWebHTTPReqAPI:@"http://passport.youmeng.com/find/checkfindcaptcha" params:param view:self.view loading:YES tableView:nil completionHandler:^(id task, id responseObject, NSError *error) {
